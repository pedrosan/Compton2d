...
c'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
c The current solving of the equation is based on the equation used in the X-ray time lags paper
            do 475 i = 2, num_nt-1
...
c            Output the new electron distribution
     ...
     1           ncycle.gt.0 .and.ncycle.lt.999) then ! Xuhui
             fntname = 'electrons/fnt_01_01_001.dat'
             fntname(15:15) = char(48 + int(j/10))
             fntname(16:16) = char(48 + j - 10*int(j/10))
             fntname(18:18) = char(48 + int(k/10))
             fntname(19:19) = char(48 + k - 10*int(k/10))
             fntname(21:21) = char(48 + int(ncycle/100))
             fntname(22:22) = char(48 + int(ncycle/10)-
     1                 10*int(ncycle/100))
             fntname(23:23) = char(48 + ncycle-
     1                 10*int(ncycle/10))
             nunit_fnt=22
