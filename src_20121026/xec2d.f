...
c
      character *35 localeventfile, evlfilename
c
...
c
c
      character*35 function evlfilename(eventfile, num)
      implicit none
      character*30 eventfile
      integer num
c
      character*35 localeventfile
c
      evlfilename(6:35) = eventfile(1:30)
         evlfilename(1:1) = 'p'
      if(num.lt.10) then
         evlfilename(2:2) = '0'
         evlfilename(3:3) = '0'
         evlfilename(4:4) = char(num+48)

      else if(num.lt.100) then
         evlfilename(2:2) = '0'
         evlfilename(3:3) = char(num/10+48)
         evlfilename(4:4) = char(num-num/10*10+48)
      else
         evlfilename(2:2) = char(num/100+48)
         evlfilename(3:3) = char((num-num/100*100)/10+48)
         evlfilename(4:4) = char(num-num/100*100
...
c     Returns name of the local record file on node num
      character*35 function recordfilename(recordfile, num)
      implicit none
      character*30 recordfile
      integer num
c
      character*35 localrecordfile
c
      recordfilename(6:35) = recordfile(1:30)
         recordfilename(1:1) = 'p'
      if(num.lt.10) then
         recordfilename(2:2) = '0'
         recordfilename(3:3) = '0'
         recordfilename(4:4) = char(num+48)

      else if(num.lt.100) then
         recordfilename(2:2) = '0'
         recordfilename(3:3) = char(num/10+48)
         recordfilename(4:4) = char(num-num/10*10+48)
      else
         recordfilename(2:2) = char(num/100+48)
         recordfilename(3:3) = char((num-num/100*100)/10+48)
         recordfilename(4:4) = char(num-num/100*100
     1        -(num-num/100*100)/10*10+48)
      endif
         recordfilename(5:5) = '_'
c
      return
      end
