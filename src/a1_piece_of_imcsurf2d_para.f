...
c     open(unit=n_input, file=fname, status='old')
      open(unit=n_input, file=fname, status='unknown') ! Xuhui Chen 05/08
      i = 0
 100  i = i + 1
...
c     dopp is the doppler factor of the photons travel from the rim of the
c     accretion disk to the jet. R_disk is the radius of the accretion disk.
      do j=1,ndisk
